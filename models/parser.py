...
from third_party.ragflow.api.db import ParserType
from third_party.ragflow.rag.nlp import rag_tokenizer, tokenize, tokenize_table, add_positions, bullets_category, \
    title_frequency, \
    tokenize_chunks
from third_party.ragflow.rag.utils import num_tokens_from_string
from third_party.ragflow.deepdoc.parser import PdfParser, ExcelParser, DocxParser,PlainParser
...
class Pdf(PdfParser):
    ...
    def __call__(self, filename, binary=None, from_page=0,
        ...
        self._concat_downward()  # 合并
        self._filter_forpages()  # 合并页眉页脚
...
def parse_pdf(filename, binary=None, from_page=0, to_page=100000,
