...
from third_party.ragflow.graphrag.query_analyze_prompt import PROMPTS
from third_party.ragflow.graphrag.utils import get_entity_type2sampels, get_llm_cache, set_llm_cache, get_relation
from third_party.ragflow.rag.utils import num_tokens_from_string, get_float
from third_party.ragflow.rag.utils.doc_store_conn import OrderByExpr

from third_party.ragflow.rag.nlp.search import Dealer, index_name
...
class KGSearch(Dealer):
    ...
    def retrieval(self, question: str,
        ...
        return {
            "chunk_id": get_uuid(),
            "content_ltks": "",
            "content_with_weight": ents + relas + self._community_retrival_([n for n, _ in ents_from_query], filters,
                                                                            kb_ids, idxnms,
                                                                            comm_topn, max_token),
            "doc_id": "",
...
if __name__ == "__main__":
    ...
    import argparse
    from third_party.ragflow.api.db import LLMType
