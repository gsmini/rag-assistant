...
from third_party.ragflow.api.db import FileType, LLMType, ParserType, StatusEnum, TaskStatus, UserTenantRole
from third_party.ragflow.api.db.db_models import DB, Document, Knowledgebase, Task, Tenant, UserTenant
from third_party.ragflow.api.db.db_utils import bulk_insert_into_db
from third_party.ragflow.api.db.services.common_service import CommonService
from third_party.ragflow.api.db.services.knowledgebase_service import KnowledgebaseService
from third_party.ragflow.api.utils import current_timestamp, get_format_time, get_uuid
from third_party.ragflow.rag.nlp import rag_tokenizer, search
from third_party.ragflow.rag.settings import get_svr_queue_name
...
def doc_upload_and_parse(conversation_id, file_objs, user_id):
    from third_party.ragflow.api.db.services.api_service import API4ConversationService
    from third_party.ragflow.api.db.services.conversation_service import ConversationService
    from third_party.ragflow.api.db.services.dialog_service import DialogService
    ...
    from third_party.ragflow.api.db.services.user_service import TenantService
    from third_party.ragflow.rag.app import audio, email, naive, picture, presentation
    ...
    for doc_id in docids:
        ...
        if parser_ids[doc_id] != ParserType.PICTURE.value:
            from  third_party.ragflow.graphrag.general.mind_map_extractor import MindMapExtractor
