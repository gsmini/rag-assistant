...
from third_party.ragflow.api.db import FileType, KNOWLEDGEBASE_FOLDER_NAME, FileSource, ParserType
from third_party.ragflow.api.db.db_models import DB, File2Document, Knowledgebase
from third_party.ragflow.api.db.db_models import File, Document
...
from third_party.ragflow.api.utils.file_utils import filename_type, thumbnail_img
...
class FileService(CommonService):
    ...
    def parse_docs(file_objs, user_id):
        from third_party.ragflow.rag.app import presentation, picture, naive, audio, email
