...
from third_party.ragflow.api.db import StatusEnum, TenantPermission
from third_party.ragflow.api.db.db_models import DB, Document, Knowledgebase, Tenant, User, UserTenant
...
class KnowledgebaseService(CommonService):
    ...
    def is_parsed_done(cls, kb_id):
        ...
        from third_party.ragflow.api.db import TaskStatus
