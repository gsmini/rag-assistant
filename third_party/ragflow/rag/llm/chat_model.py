...
from third_party.ragflow.rag.nlp import is_chinese, is_english
...
class LocalLLM(Base):
    ...
    def _prepare_prompt(self, system, history, gen_conf):
        from third_party.ragflow.rag.svr.jina_server import Prompt
    ...
    def _stream_response(self, endpoint, prompt):
        from third_party.ragflow.rag.svr.jina_server import Generation
