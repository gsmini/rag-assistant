...
from third_party.ragflow.rag.utils import singleton
import pandas as pd
from third_party.ragflow.api.utils.file_utils import get_project_base_directory

from third_party.ragflow.rag.utils.doc_store_conn import (
    DocStoreConnection,
    MatchExpr,
    MatchTextExpr,
    MatchDenseExpr,
...
class InfinityConnection(DocStoreConnection):
    ...
    def field_keyword(self, field_name: str):
        ...
        if field_name == "source_id" or (
                field_name.endswith("_kwd") and field_name != "docnm_kwd" and field_name != "knowledge_graph_kwd"):
            return True
        return False
